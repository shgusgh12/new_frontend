      ...
      <ul className={styles.aside_container}>
        <NavLink className={getAsideActiveClassName} to="/mypage/portfolio">
          <span>
            <img
              style={{ marginTop: "5px" }}
              src={process.env.PUBLIC_URL + "/icon/piechart.svg"}
              alt=""
            />
          </span>
          <span>내 포트폴리오</span>
        ...
        <NavLink className={getAsideActiveClassName} to="/mypage/ledger">
          <span>
            <img
              style={{ marginTop: "5px" }}
              src={process.env.PUBLIC_URL + "/icon/creditcard.svg"}
              alt=""
            />
          </span>
          <span>가계부</span>
        ...
        <NavLink className={getAsideActiveClassName} to="/mypage/scrap">
          <span>
            <img
              style={{ marginTop: "5px" }}
              src={process.env.PUBLIC_URL + "/icon/bookmark.svg"}
              alt=""
            />
          </span>
          <span>스크랩</span>
        ...
        <NavLink className={getAsideActiveClassName} to="/mypage/post">
          <span>
            <img
              style={{ marginTop: "5px" }}
              src={process.env.PUBLIC_URL + "/icon/document.svg"}
              alt=""
            />
          </span>
          <span>게시물 관리</span>
        ...
        <NavLink className={getAsideActiveClassName} to="/mypage/settings">
          <span>
            <img
              style={{ marginTop: "5px" }}
              src={process.env.PUBLIC_URL + "/icon/settings.svg"}
              alt=""
            />
          </span>
          <span>내 정보 수정</span>
        ...
        <NavLink className={getAsideActiveClassName} to="/mypage/faq">
          <span>
            <img
              style={{ marginTop: "5px" }}
              src={process.env.PUBLIC_URL + "/icon/question.svg"}
              alt=""
            />
          </span>
          <span>FAQ</span>
        ...
        <NavLink className={getAsideActiveClassName} to="/mypage/consult">
          <span>
            <img
              style={{ marginTop: "5px" }}
              src={process.env.PUBLIC_URL + "/icon/consult.svg"}
              alt=""
            />
          </span>
          <span>고객센터</span>
